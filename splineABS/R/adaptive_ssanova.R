...
#' @param calculateTime A boolean whether calculate the time of fitted model.
...
#'
#'         If required return index of samples, return a list named \code
#'         {fitModel}(list) and \code{sample.index}(vector).
#'
#' @seealso
